...
st.write("This is a fork of the sample demo by Lavaa.")

st.write(
    "For more details, take a look at the workshop's [walkthrough](https://msu-ai.notion.site/LangChain-Apps-MSU-AI-Club-7fbdc17aa0f6415a8d7606cfb1e41e00)"
)
